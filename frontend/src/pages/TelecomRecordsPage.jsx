          ...
          <div className="rounded-lg border border-dashed border-primary/30 bg-primary/5 p-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-body">Upload telecom test file</p>
                  <p className="text-sm text-slate-500">Attach one or more supporting files for this telecom test row.</p>
                </div>
              </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[1250px] divide-y divide-border">
              <thead className="bg-primary text-white">
                <tr>
                  {["Sr.No.", "Test Date", "Fiber Length", "Fiber Details", "Wavelength", "Test By", "Remark", "File", "Action"].map(
                    (label) => (
